            ...
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <img src="{{ asset($director->image->url . '/' . $director->image->image) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control text-capitalize"
                                            value="{{ $director->name }}" aria-describedby="helpId">
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lastname" class="form-control text-capitalize"
                                            value="{{ $director->lastname }}" aria-describedby="helpId">
                                        @error('lastname')
                                            <small id="helpId" class="text-white bg-appsalidas">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="code" class="form-control" value="{{ $director->code }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email" class="form-control" value="{{ $director->email }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="emailu" class="form-control"
                                            value="{{ $director->emailu }}" aria-describedby="helpId">
                                        @error('emailu')
                                            <small id="helpId" class="text-white bg-appsalidas">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select text-capitalize" name="program_id">
                                            ...
                                            @foreach ($programs as $program)
                                                @if ($director->program->code == $program->code)
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" class="form-control text-capitalize"
                                            value="{{ $director->address }}" aria-describedby="helpId">
                                        @error('address')
                                            <small id="helpId" class="text-white bg-appsalidas">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone" class="form-control text-capitalize"
                                            value="{{ $director->phone }}" aria-describedby="helpId">
                                        @error('phone')
                                            <small id="helpId" class="text-white bg-appsalidas">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="document" class="form-control text-capitalize"
                                            value="{{ $director->document->document }}" aria-describedby="helpId">
                                        @error('document')
                                            <small id="helpId" class="text-white bg-appsalidas">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select text-capitalize" name="document_type_id">
                                            ...
                                            @foreach ($document_types as $doct_type)
                                                @if ($director->document->dtype->type == $doct_type->type)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="birthday" class="form-control text-capitalize"
                                            value="{{ $director->birthday }}" aria-describedby="helpId" min="1940-01-01"
                                            max="2004-12-31">
                                        @error('birthday')
                                            <small id="helpId" class="text-white bg-appsalidas">{{ $message }}</small>
                                        @enderror
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('user.update-photo') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                        <input type="hidden" name="user_email" value="{{ $director->emailu }}">
                        <div class="form-group">
